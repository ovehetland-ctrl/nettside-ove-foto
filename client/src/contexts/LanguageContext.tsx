...
const translations: Record<Language, Record<string, string>> = {
  no: {
    ...
    'gallery.img5.title': 'Markjordbær',
    'gallery.img5.subtitle': 'Fragaria vesca',
    ...
    'about.p1': 'Det begynte med et kamera og en nysgjerrighet som ikke lot seg stanse. Ti år gammel oppdaget jeg at verden sett gjennom et linse var en annen verden — mer intens, mer presis, mer sann.',
  ...
  en: {
    ...
    'gallery.img4.subtitle': 'Leucanthemum vulgare',
    'gallery.img5.title': 'Wild Strawberry',
    'gallery.img5.subtitle': 'Fragaria vesca',
    ...
    'about.p1': 'It began with a camera and a curiosity that refused to be contained. At ten years old, I discovered that the world seen through a lens was a different world — more intense, more precise, more true.',
